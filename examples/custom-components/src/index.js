...
import {
  BillingAddress, CheckoutButton, CheckoutProvider, OrderProcessed, OrderProcessing, PaymentMethod, ShippingAddress, ShippingLines, SummaryCollapsed, useCheckoutStore,
} from '@boldcommerce/checkout-react-components';
import '@boldcommerce/checkout-react-components/dist/styles.css';
import CustomCustomer from './CustomCustomer';
